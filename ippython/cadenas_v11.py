# -*- coding: utf-8 -*-
"""
Created on Thu Mar 21 07:59:17 2013

@author: daniel
"""

#programa:cadenas_v11.py
    ...
    for i in range(0,len(cadena)):  #calcula espacios en blanco
        ...
        if cadena[i] == ' ' and cadena[i-1] != ' ':
            ...
            if cantidad >= num + 1:
                ...
                cantidad = 0
    if num_1 >= cambio:
        print 'hay palabra(s) con %d o mas caracteres.' %num
    else:
        print 'todas las palabras tiene menos de %d caracteres.' %num
    cadena = raw_input('Escribe una frase: ')
    if cadena == ' ':
